...
public class FederationClient extends ClientBase {
	...
	public JsonResponse updateParams(ModelData modelData) throws RestClientException {
		return restTemplate.postForObject(UPDATE_PARAMS, modelData, JsonResponse.class);
	}
