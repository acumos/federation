...
public class FederationClient extends ClientBase {
	 ...
	 */
	public JsonResponse receiveModelData(ModelData modelData) throws RestClientException {
		return restTemplate.postForObject(MODEL_DATA, modelData, JsonResponse.class);
	}
