...
public class GatewayClient extends ClientBase {
	 ...
	 * @param modelData log data for sending to supplier of model
	 */
	public void updateParams(String peerId, ModelData modelData)
			throws RestClientException {
		restTemplate.postForObject(PEER_PFX + FederationClient.UPDATE_PARAMS, modelData, Void.class, peerId);
	}
}
