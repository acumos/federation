...
@SpringBootTest(classes = org.acumos.federation.gateway.Application.class, webEnvironment = WebEnvironment.RANDOM_PORT, properties = {
		...
		"federation.ssl.client-auth=need", "federation.registration.enabled=true" })
...
public class ControllerTest {
	...
	public void testSolutionSuccess() {
		...
		ResponseEntity<JsonResponse<MLPSolution>> response = this.restTemplate.exchange(
				"/solutions/00000000-0000-0000-0000-000000000000", HttpMethod.GET, prepareRequest(),
	...
	public void testSolutionRevisionsSuccess() {
		...
		ResponseEntity<JsonResponse<List<MLPSolutionRevision>>> response = this.restTemplate.exchange(
				"/solutions/00000000-0000-0000-0000-000000000000/revisions", HttpMethod.GET, prepareRequest(),
	...
	public void testSolutionRevisionSuccess() {
		...
		ResponseEntity<JsonResponse<MLPSolution>> response = this.restTemplate.exchange(
				"/solutions/00000000-0000-0000-0000-000000000000/revisions/01010101-0101-0101-0101-010101010101",
				HttpMethod.GET, prepareRequest(), new ParameterizedTypeReference<JsonResponse<MLPSolution>>() {
				});
	...
	public void testSolutionRevisionArtifactsSuccess() {
		...
		ResponseEntity<JsonResponse<List<MLPArtifact>>> response = this.restTemplate.exchange(
				"/solutions/00000000-0000-0000-0000-000000000000/revisions/01010101-0101-0101-0101-010101010101/artifacts",
				HttpMethod.GET, prepareRequest(), new ParameterizedTypeReference<JsonResponse<List<MLPArtifact>>>() {
				});
	...
	public void testRegister() {
		...
		assertTrue(response != null);
		assertTrue("Expected 202 status code, got " + response.getStatusCodeValue(),
				response.getStatusCodeValue() == 202);

		// an attempt to re-register should trigger an error
		response = this.restTemplate.exchange("/peer/register", HttpMethod.POST, prepareRequest(),
		...
		assertTrue(response != null);
		assertTrue("Expected 400 status code, got " + response.getStatusCodeValue(),
	...
	public void testUnregister() {
		...
		ResponseEntity<JsonResponse<MLPPeer>> response = this.restTemplate.exchange("/peer/unregister", HttpMethod.POST,
				prepareRequest(), new ParameterizedTypeReference<JsonResponse<MLPPeer>>() {
				});
		if (response != null) {
	...
	public void testPeersForbidden() {
		...
		ResponseEntity<JsonResponse<List<MLPPeer>>> response = this.restTemplate.exchange("/peers", HttpMethod.GET,
	...
	private HttpClient prepareHttpClient(String theIdentity) {
		return new InterfaceConfigurationBuilder().withSSL(
				new SSLBuilder().withKeyStore("classpath:/" + theIdentity + ".pkcs12").withKeyStorePassword(theIdentity)
