...
public class GatewayController {
	...
	@ResponseBody
	public JsonResponse peerModelData(HttpServletResponse theHttpResponse,
		...
		modelInfo.setSubscriberId(self.getSubjectName());
		...
		try {
			...
			return callPeer(theHttpResponse, peerId, peer -> peer.receiveModelData(payload));
		} catch (Exception ex) {
