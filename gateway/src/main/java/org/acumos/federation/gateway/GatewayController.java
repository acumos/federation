...
public class GatewayController {
	...
	public JsonResponse<List<MLPCatalog>> getCatalogs(
		...
		log.debug(GatewayClient.PEER_PFX + FederationClient.CATALOGS_URI, peerId);
	...
	public JsonResponse<List<MLPSolution>> getSolutions(
		...
		log.debug(GatewayClient.PEER_PFX + FederationClient.SOLUTIONS_URI, peerId);
	...
	public JsonResponse<MLPSolution> getSolution(
		...
		log.debug(GatewayClient.PEER_PFX + FederationClient.SOLUTION_URI, peerId, solutionId);
	...
	public JsonResponse<List<MLPPeer>> getPeers(
	    HttpServletResponse response,
	    @PathVariable("peerId") String peerId) {
		log.debug(GatewayClient.PEER_PFX + FederationClient.PEERS_URI, peerId);
	...
	public JsonResponse<MLPPeer> ping(
	    HttpServletResponse response,
	    @PathVariable("peerId") String peerId) {
		log.debug(GatewayClient.PEER_PFX + FederationClient.PING_URI, peerId);
	...
	public JsonResponse<MLPPeer> register(
	    HttpServletResponse response,
	    @PathVariable("peerId") String peerId) {
		log.debug(GatewayClient.PEER_PFX + FederationClient.REGISTER_URI, peerId);
	...
	public JsonResponse<Void> triggerPeerSubscription(
		...
		log.debug(GatewayClient.PEER_PFX + GatewayClient.SUBSCRIPTION_URI, peerId, subscriptionId);
		...
		if (subscription == null || !peerId.equals(subscription.getPeerId())) {
			...
			peerGateway.triggerSubscription(subscription);
