...
public class FederationClient extends AbstractClient {
	...
	public StreamingResource getArtifactContent(String theArtifactId) throws FederationException {
		return download2(API.ARTIFACT_CONTENT.buildUri(this.baseUrl, theArtifactId));
	}
	...
	public StreamingResource getDocumentContent(String theDocumentId) throws FederationException {
		return download2(API.DOCUMENT_CONTENT.buildUri(this.baseUrl, theDocumentId));
	}
	...
	private Resource download(URI theUri) throws FederationException {
	 ...
	 * @throws FederationException on failure
	 */
	private StreamingResource download2(URI theUri) throws FederationException {
