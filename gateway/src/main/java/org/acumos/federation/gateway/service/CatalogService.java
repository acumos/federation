 ...
 * the peer on whose behalf the service is executed only accesses solutions
...
public interface CatalogService {
	 ...
	 * @param theSolutionId identifier of the solution whose revisions are
	 * to be provided
	 * @param theContext the execution context
	 ...
	 *
	 * @param theArtifactId identifier of the acumos artifact whose content
