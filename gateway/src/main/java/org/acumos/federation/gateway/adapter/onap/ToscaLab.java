...
/**
 * Java interface to Shu Shi's ToscaLab python code
 */
...
/*
		...
		PythonInterpreter.initialize(System.getProperties(),
																 ...
																 new String[] {"-i","stdin",
																							 //"-o", ".",
																							 "-m", "/data/meta_model/meta_tosca_schema.yaml"});
		PythonInterpreter python = new PythonInterpreter();
		python.setIn(new FileInputStream(theArgs[0]));
		ByteArrayOutputStream out = new ByteArrayOutputStream();
		python.setOut(out);

		InputStream script = ClassLoader.getSystemResourceAsStream("model_create.py");
		if (script == null)
			System.out.println("Cannot load script");
		else
...
*/
	...
	public String create_model(InputStream theSpec) {
