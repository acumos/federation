...
public abstract class ServiceImpl {
	 ...
	 * @throws IllegalArgumentException if the value of key, in theSelector is neither a String nor a List.
	 */

	private static Predicate<MLPSolution> contains(Map<String, ?> theSelector, String key, Function<MLPSolution, Set<String>> field, boolean listok) throws IllegalArgumentException {
	...
	private static Predicate<MLPSolution> has(Map<String, ?> theSelector, String key, Function<MLPSolution, String> field, boolean listok) throws IllegalArgumentException {
		Object o = theSelector.get(key);
		if (o == null) {
			return(null);
		}
	 ...
	 * @throws IllegalArgumentException if theSelector is malformed
	 */

	public static Predicate<MLPSolution> compileSelector(Map<String, ?> theSelector) throws IllegalArgumentException {
		if (theSelector == null) {
			return(arg -> true);
		}
