...
public class LogstashClient extends ClientBase {
	...
	public ModelData saveModelData(HttpEntity<ModelData> httpEntity){
		return this.handleResponse("/", HttpMethod.POST, httpEntity, new ParameterizedTypeReference<JsonResponse<ModelData>>(){});
	}
