...
public class LogstashClient extends ClientBase {
	...
	public JsonNode saveModelData(HttpEntity<JsonNode> httpEntity){
		return this.handleResponse("/", HttpMethod.POST, httpEntity, new ParameterizedTypeReference<JsonResponse<JsonNode>>(){});
	}
